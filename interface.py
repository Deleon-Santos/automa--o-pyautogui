...
def publicar():
    desc =  entry_texto_descritivo.get("1.0", "end") # Obtém o texto do campo "descrição"
    caminho = arquivo.get()
...
label_texto_descritivo = ctk.CTkLabel(master=app, text="texto descritivo:").place(x = 60, y = 90)

entry_texto_descritivo = ctk.CTkTextbox(master = app, width = 420, height = 70)
entry_texto_descritivo.place(x = 60, y = 120) 
